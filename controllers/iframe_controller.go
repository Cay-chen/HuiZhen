...
func (c *IframeController) Get() {
	if c.IsLogin {
		...
		case "myHz":
			/*			if c.IsYwb{
							c.Data["BarDemo"] = "{{# if(d.JYConFormPolicy == 0){ }}\n<a class=\"layui-btn layui-btn-danger layui-btn-xs layui-btn-disabled\">作废</a>\n{{# }else { }}\n<a class=\"layui-btn layui-btn-danger layui-btn-xs \" lay-event=\"zuofei\">作废</a>\n{{# } }}"
							//c.Data["BarDemo"] = "<a class=\"layui-btn layui-btn-danger layui-btn-xs \" lay-event=\"zuofei\">作废</a> "
						}else {
			...
			//c.Data["BarDemo"] = "    {{# if(d.JYConFormPolicy == 1){ }}\n   <a class=\"layui-btn layui-btn-xs\" lay-event=\"edit\">编辑</a>\n   <a class=\"layui-btn layui-btn-xs\" lay-event=\"submit\">提交</a>\n   <a class=\"layui-btn layui-btn-danger layui-btn-xs\" lay-event=\"del\">删除</a>\n   <a class=\"layui-btn layui-btn-danger layui-btn-xs \" lay-event=\"zuofei\">作废\n    {{# }else if(d.JYConFormPolicy == 0) { }}\n    <a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >编辑</a>\n    <a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >提交</a>\n    <a class=\"layui-btn layui-btn-danger layui-btn-xs layui-btn-disabled\" >删除</a>\n    <a class=\"layui-btn layui-btn-danger layui-btn-xs layui-btn-disabled\">作废</a>\n   {{# }else{ }}\n   <a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >编辑</a>\n    <a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >提交</a>\n    <a class=\"layui-btn layui-btn-danger layui-btn-xs layui-btn-disabled\" >删除</a>\n    <a class=\"layui-btn layui-btn-danger layui-btn-xs \" lay-event=\"zuofei\">作废\n    {{# } }}"
			c.Data["BarDemo"] = "   {{# if(d.JYConFormPolicy == 1){ }}\n   <a class=\"layui-btn layui-btn-xs\" lay-event=\"edit\">编辑</a>\n   <a class=\"layui-btn layui-btn-xs\" lay-event=\"submit\">提交</a>\n   <a class=\"layui-btn layui-btn-danger layui-btn-xs\" lay-event=\"del\">删除</a>\n   <a class=\"layui-btn layui-btn-danger layui-btn-xs \" lay-event=\"zuofei\">作废</a>\n    {{# }else if(d.JYConFormPolicy == 0 ||d.JYConFormPolicy == 7 ) { }}\n    <a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >编辑</a>\n    <a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >提交</a>\n    <a class=\"layui-btn layui-btn-danger layui-btn-xs layui-btn-disabled\" >删除</a>\n    <a class=\"layui-btn layui-btn-danger layui-btn-xs layui-btn-disabled\">作废</a>\n   {{# }else { }}\n   <a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >编辑</a>\n    <a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >提交</a>\n    <a class=\"layui-btn layui-btn-danger layui-btn-xs layui-btn-disabled\" >删除</a>\n    <a class=\"layui-btn layui-btn-danger layui-btn-xs \" lay-event=\"zuofei\">作废</a>\n    {{# } }}"
			/*			c.Data["A1"] = "{{# if(d.JYConFormPolicy == 1){ }}"
						c.Data["A2"] = "{{# }else{ }}"
						c.Data["A3"] = "{{# } }}"*/
			//c.Data["BarDemo"] = "    {{# if(d.JYConFormPolicy == 1){ }}\n    <a class=\"layui-btn layui-btn-xs\" lay-event=\"edit\">编辑</a>\n    <a class=\"layui-btn layui-btn-xs\" lay-event=\"submit\">提交</a>\n    <a class=\"layui-btn layui-btn-danger layui-btn-xs\" lay-event=\"del\">删除</a>\n    {{# }else{ }}\n    <a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >编辑</a>\n    <a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >提交</a>\n    <a class=\"layui-btn layui-btn-danger layui-btn-xs layui-btn-disabled\" >删除</a>\n    {{# } }}"
			//c.Data["BarDemo"] = "{{# if(d.JYConFormPolicy == 1){ }}\n<a class=\"layui-btn layui-btn-xs\" lay-event=\"edit\">编辑</a>\n<a class=\"layui-btn layui-btn-xs\" lay-event=\"submit\">提交</a>\n<a class=\"layui-btn layui-btn-danger layui-btn-xs\" lay-event=\"del\">删除</a>\n{{# }else if(d.JYConFormPolicy == 4){ }}\n<a class=\"layui-btn layui-btn-danger layui-btn-xs \" lay-event=\"zuifei\">作废</a>\n{{# }else if(d.JYConFormPolicy == 0){ }}\n<a class=\"layui-btn layui-btn-danger layui-btn-xs \" lay-event=\"zuifei\">作废</a>\n<a class=\"layui-btn layui-btn-xs \" >编辑</a>\n<a class=\"layui-btn layui-btn-xs \" >提交</a>\n<a class=\"layui-btn layui-btn-danger layui-btn-xs \" >删除</a>\n{{# }else { }}\n<a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >编辑</a>\n<a class=\"layui-btn layui-btn-xs layui-btn-disabled\" >提交</a>\n<a class=\"layui-btn layui-btn-danger layui-btn-xs layui-btn-disabled\" >删除1</a>\n{{# } }}"
